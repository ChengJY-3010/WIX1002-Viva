...
public class Q5_DigitGrouping {
    ...
    public static void main(String[] args) {
        ...
        //Output the results
        System.out.println("Total number of digits group: " + numGroup);
        System.out.println("Longest group is " + longestDigit + " with length " + longestGrpLength);
        System.out.println("The sum of the lengths of all digit groups: " + sumGrpLength);
